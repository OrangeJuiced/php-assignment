...
<header class="bg-white shadow-sm lg:static lg:overflow-y-visible">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:divide-y lg:divide-gray-200">
        ...
        <nav class="py-4 flex space-x-8" aria-label="Global">
            <a href="/bicycles" class="bg-gray-100 text-gray-900 rounded-md py-2 px-3 inline-flex items-center text-sm font-medium" aria-current="page">Bicycles</a>

            <a href="/suppliers" class="text-gray-900 hover:bg-gray-50 hover:text-gray-900 rounded-md py-2 px-3 inline-flex items-center text-sm font-medium">Suppliers</a>
        </nav>
    </div>
</header>
